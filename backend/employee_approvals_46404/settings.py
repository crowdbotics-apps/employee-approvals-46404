"""
Django settings for employee_approvals_46404 project.
...
ROOT_URLCONF = 'employee_approvals_46404.urls'
...
WSGI_APPLICATION = 'employee_approvals_46404.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "employee_approvals_46404 API",
    "DESCRIPTION": "API documentation for employee_approvals_46404 App",
    "VERSION": "v1",
}
